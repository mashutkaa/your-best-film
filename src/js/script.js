...
window.addEventListener('DOMContentLoaded', function() {
    ...
    function showQuestion(questions) {
        ...
        questions.forEach((element, index) => {
            ...
            switch(element['type']) {
                ...
                case 'range': {
                    const sliderTemplate = `
                        <div class = "slider-group">
                            <input id="lower-slider" class="second-field" type="range" min="0" max="7" step="1" value="0" required />
                            <input id="upper-slider" class="second-field-max" type="range" min="0" max="7" step="1" value="0" required />
                        </div>
                        <div class="slider-labels"></div>
                    `;
                    questionContainer.innerHTML += sliderTemplate;

                    const sliderContainer = questionContainer.querySelector('.slider-labels');
                ...
                case 'option': {
                    const options = element.answers.split(', ')
    ...
    function sendResults(questions) {
        questions.forEach(element => {
            ...
            switch(type) {
                case 'radio-mood': {
                    const getAnswer = document.querySelector('input[name="mood"]:checked')?.value || null;
                ...
                case 'radio': {
                    const getAnswer = document.querySelector('input[name="movie-partner"]:checked')?.value || null;
                ...
                case 'input-fields': {
                    const answerMin = document.querySelector('input[name="year-min-0"]').value || null;
                    const answerMax = document.querySelector('input[name="year-min-1"]').value || null;
                ...
                case 'option': {
                    const answers = document.querySelector('select[name="genre"]').value || null;
