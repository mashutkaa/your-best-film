...
app.post("/api/getMovieRecommendations", async (req, res) => {
    try {
        ...
        Використай інформацію нижче для створення рекомендацій, перевір щоб фільм підходив по абсолютно усім питанням (наприклад роки, жанр фільму мають відповідати запитанням):
