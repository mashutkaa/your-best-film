...
/* harmony export */ });
/* harmony import */ var _saveFilm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./saveFilm */ "./src/js/resultPage/saveFilm.js");
...
var addSaveFilmButtonEventListeners = function addSaveFilmButtonEventListeners(checkedRecommendations) {
  document.querySelectorAll(".save-film").forEach(function (button) {
    button.addEventListener("click", function (event) {
      ...
      console.log("Film ID: ".concat(id), film);
      if (!isSaved) {
        (0,_saveFilm__WEBPACK_IMPORTED_MODULE_0__["default"])(film, button);
      } else {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var saveFilm = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(filmObj, button) {
    var newFilm, response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          newFilm = {
  ...
  return function saveFilm(_x, _x2) {
...
/* harmony import */ var _saveFilm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./saveFilm */ "./src/js/resultPage/saveFilm.js");
/* harmony import */ var _saveRecommendation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./saveRecommendation */ "./src/js/resultPage/saveRecommendation.js");
...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  // saveFilm();
  (0,_saveRecommendation__WEBPACK_IMPORTED_MODULE_2__["default"])();
});
})();
