    ...
    fetch(url).then(function (response) {
      ...
      if (data.results) {
        var filteredMovies = data.results.filter(function (movie) {
          return movie.vote_average >= 6.5 && movie.overview.trim() !== "";
        });
...
/***/ "./src/js/filmsSearch/addFiltersModal.js":
/*!***********************************************!*\
  !*** ./src/js/filmsSearch/addFiltersModal.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var addFiltersModal = function addFiltersModal() {
  ...
  filtersForm.onsubmit = function (event) {
    ...
    alert("\u0424\u0456\u043B\u044C\u0442\u0440\u0438: \u0416\u0430\u043D\u0440 - ".concat(genre, ", \u0420\u0456\u043A - ").concat(year, ", \u0420\u0435\u0439\u0442\u0438\u043D\u0433 - ").concat(rating));
    modal.style.display = "none";
  };
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addFiltersModal());
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _addFiltersModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addFiltersModal */ "./src/js/filmsSearch/addFiltersModal.js");
/* harmony import */ var _newFilters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./newFilters */ "./src/js/filmsSearch/newFilters.js");
