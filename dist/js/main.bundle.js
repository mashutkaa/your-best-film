...
var bestFilms = function bestFilms() {
  ...
  scheduleNextCheck();
  getBestMovies();
  var handleBestMovies = function handleBestMovies(movies) {
    movies.forEach(function (movie, index) {
      var title = movie.title,
        description = movie.description,
        rating = movie.rating,
        poster = movie.poster;
      var descriptionMovie = description;
      if (descriptionMovie.length > 350) {
        descriptionMovie = description.slice(0, 320) + "...";
      }
      var film = document.getElementById("".concat(index + 1, "-best-film"));
...
/***/ "./src/js/filmsSearch/filmsSearch.js":
/*!*******************************************!*\
  !*** ./src/js/filmsSearch/filmsSearch.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _newFilters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./newFilters */ "./src/js/filmsSearch/newFilters.js");
/* harmony import */ var _isOpenNewFilters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./isOpenNewFilters */ "./src/js/filmsSearch/isOpenNewFilters.js");
...
var filmsSearch = function filmsSearch() {
  var shortQuestions = [{
    type: "radio-mood",
        ...
        if (event.target.name === "continue-or-send-results") {
          if (event.target.value === "Так") {
            ...
            document.getElementById("submitNewFilters").addEventListener("click", function () {
              ...
              var formattedAnswers = [location ? "\u041F\u043E\u0434\u0456\u0457 \u0444\u0456\u043B\u044C\u043C\u0443 \u0432\u0456\u0434\u0431\u0443\u0432\u0430\u044E\u0442\u044C\u0441\u044F \u0443 \u0442\u0430\u043A\u0456\u0439 \u043B\u043E\u043A\u0430\u0446\u0456\u0457: ".concat(location) : null, plotComplexity ? "\u0421\u044E\u0436\u0435\u0442 ".concat(plotComplexity === "Більш легкий та простий" ? "більш легкий та простий" : "більш заплутаний та глибокий") : null, timePeriod ? "\u0424\u0456\u043B\u044C\u043C \u043F\u0440\u043E \u0447\u0430\u0441\u043E\u0432\u0438\u0439 \u043F\u0440\u043E\u043C\u0456\u0436\u043E\u043A: ".concat(timePeriod) : null, basedOnTrueEvents ? "\u0424\u0456\u043B\u044C\u043C ".concat(basedOnTrueEvents === "true" ? "засновано на реальних подіях" : "не засновано на реальних подіях") : null, preferredEnding ? "\u0424\u0456\u043D\u0430\u043B \u043C\u0430\u0454 \u0431\u0443\u0442\u0438: ".concat(preferredEnding) : null];
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (filmsSearch);

/***/ }),

/***/ "./src/js/filmsSearch/isOpenNewFilters.js":
/*!************************************************!*\
  !*** ./src/js/filmsSearch/isOpenNewFilters.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (isOpenNewFilters);

/***/ }),

/***/ "./src/js/filmsSearch/newFilters.js":
/*!******************************************!*\
  !*** ./src/js/filmsSearch/newFilters.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var newFilters = function newFilters() {
...
/*!**************************!*\
  ...
  \**************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bestFilms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bestFilms */ "./src/js/bestFilms.js");
/* harmony import */ var _filmsSearch_filmsSearch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filmsSearch/filmsSearch */ "./src/js/filmsSearch/filmsSearch.js");


window.addEventListener("DOMContentLoaded", function () {
  (0,_bestFilms__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_filmsSearch_filmsSearch__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
})();
